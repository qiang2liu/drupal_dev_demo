 ...
 */
function fte_preprocess_html(&$variables) {
 ...
 */
function fte_process_html(&$variables) {
 ...
 */
function fte_process_page(&$variables) {
  // Hook into color.module.
  if (module_exists('color')) {
 ...
 */
function fte_preprocess_maintenance_page(&$variables) {
  ...
  drupal_add_css(drupal_get_path('theme', 'fte') . '/css/maintenance-page.css');
}
 ...
 */
function fte_preprocess_node(&$variables) {
 ...
 */
function fte_preprocess_block(&$variables) {
 ...
 */
function fte_menu_tree($variables) {
 ...
 */
function fte_field__taxonomy_term_reference($variables) {
  $output = '';
